<template>
    <div class="home">
        <div class="hero bg-grey-darkest mb-24">
            <div class="container flex flex-col lg:flex-row lg:justify-between py-10">
                <div class="mt-10">
                    ...
                    <div class="flex items-center">
                        <a href="#" class="bg-blue-dark text-white rounded px-4 py-4 mr-4 hover:bg-blue">View Books</a>
                    </div>
                </div>
                    ...
                    <ApolloQuery :query="categoriesQuery">
                        <template slot-scope="{ result: { data, loading }, isLoading }">
                            ...
                            <ul v-else class="list-reset text-lg">
                                <li class="mb-6">
                                    <a href="#" class="text-grey hover:text-white" @click.prevent="selectCategory('all')">All</a>
                                </li>
                                <li class="mb-6">
                                    <a href="#" class="text-grey hover:text-white" @click.prevent="selectCategory('featured')">Featured</a>
                                </li>
                                <li v-for="category of data.categories" :key="category.id" class="mb-6">
                                    <a href="#" class="text-grey hover:text-white" @click.prevent="selectCategory(category.id)">{{ category.name }}</a>
                                </li>
                                <li class="mb-6">
                                    <router-link to="/books/add" class="text-grey hover:text-white">Add a book</router-link>
                                </li>
